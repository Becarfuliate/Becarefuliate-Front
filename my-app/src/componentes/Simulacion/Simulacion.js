...
function Simulation() {
  ...
  pieces.push({id: 69, image: "https://opengameart.org/sites/default/files/styles/medium/public/robot-preview.png", x: valuex, y: valuey, name: 'lichi-bot', health: 100, facing: 90, motor: 0});
