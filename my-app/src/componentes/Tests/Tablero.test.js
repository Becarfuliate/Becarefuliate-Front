...
test("Renderiza Tablero", () => {
    ...
    ronda0.push({id: 0, imagen: "https://opengameart.org/sites/default/files/styles/medium/public/robot-preview.png", x: 500, y: 1000, xf: 700, yf: 1000, nombre: 'Joe', vida: 45, mira: 360, motor: 0, xmis: 500, ymis: 1000, xmisf: 500, ymisf: 340});
    ...
    ronda1.push({id: 0, imagen: "https://opengameart.org/sites/default/files/styles/medium/public/robot-preview.png", x: 700, y: 1000, xf: 900, yf: 1000, nombre: 'Joe', vida: 45, mira: 360, motor: 0, xmis: 700, ymis: 1000, xmisf: 500, ymisf: 340});
    ...
    ronda2.push({id: 0, imagen: "https://opengameart.org/sites/default/files/styles/medium/public/robot-preview.png", x: 900, y: 1000, xf: 1000, yf: 900, nombre: 'Joe', vida: 45, mira: 360, motor: 0, xmis: 900, ymis: 1000, xmisf: 500, ymisf: 340});
    ...
    ronda3.push({id: 0, imagen: "https://opengameart.org/sites/default/files/styles/medium/public/robot-preview.png", x: 1000, y: 900, xf: 1000, yf: 900, nombre: 'Joe', vida: 45, mira: 360, motor: 0, xmis: null, ymis: null, xmisf: null, ymisf: null});
    ...
    const component = render(<Tablero rondas={rondas}/>);
